...
#load functions
source("snp2go.R") #pulled from davidszkiba/snp2go/snp2go.R on GitHub (as all other functions are)
source("ProcessGFF.R")
source("ProcessMartExport.R")
source("GetProgressBarIncrementer.R")
source("ComputeLevels.R")
source("RemoveFromUpperLevels.R")
source("ComputeSNPsByLevel.R")
source("GetAllRegionsAndSNPs.R")
source("GetCandidateTerms.R")
source("GetStatistic.R")
source("FindLevel.R")
source("SamplingTest.R")
source("AddOffspringInformation.R")
